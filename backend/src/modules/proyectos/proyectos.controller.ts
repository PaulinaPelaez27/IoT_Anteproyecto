...
export class ProyectosController {
  ...
  @Post()
  create(@Headers('x-empresa-id') empresaId: string | undefined, @Body() createProyectoDto: CreateProyectoDto) {
  ...
  @Get(':id')
  findOne(@Headers('x-empresa-id') empresaId: string | undefined, @Param('id') id: string) {
    const perfil = { p_id_empresa: empresaId ? Number(empresaId) : undefined };
  ...
  @Delete(':id')
  remove(@Headers('x-empresa-id') empresaId: string | undefined, @Param('id') id: string) {
    const perfil = { p_id_empresa: empresaId ? Number(empresaId) : undefined };
